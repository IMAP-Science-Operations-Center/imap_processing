...
J2000_TT_EPOCH = np.datetime64("2000-01-01T11:58:55.816", "ns")
...
def met_to_tt_ns(
    ...
    return np.asarray(sct_to_tt(sclk_ticks) * 1e9, dtype=np.int64)


@typing.no_type_check
@ensure_spice
def tt_ns_to_et(tt_ns: npt.ArrayLike) -> npt.NDArray[float]:
    """
