...
catdesc_fieldname_l1a = {
    ...
    "glows_ssclk_last_pps" : ["GLOWS subseconds for last PPS, with a max of 2000000", "GLOWS subseconds for last PPS"],
    ...
    "spin_period_valid" : ["Indicates if the spin phase is valid", "Valid spin phase flag"],
    "spin_phase_at_next_pps_valid" : ["Indicates if the spin phase at next PPS is valid", "Spin phase at next PPS is valid"],
    ...
    "spin_phase_at_next_pps" : ["Uint encoded next spin phase value", "Uint encoded next spin phase value"],
    "number_of_completed_spins" : ["Number of spins, from onboard", "Number of spins, from onboard"],
    "filter_temperature" : ["Uint encoded temperature", "Uint encoded temperature"],
    "hv_voltage" : ["Uint encoded voltage", "Uint encoded voltage"],
    "glows_time_on_pps_valid" : ["Indicates if the glows time is valid", "Flag - is glows time valid"],
    ...
    "is_pps_autogenerated" : ["Indicates if PPS is autogenerated", "Indicates if PPS is autogenerated"],
    ...
    "missing_packet_sequences": ["Missing packet sequence numbers", "Missing packet sequences"],
}
