...
def test_sci_de_decom(hi_l0_test_data_path):
    ...
    # Write to CDF
    cdf_filename = "imap_hi_l1a_90sensor-de_20241105_v999.9999.cdf"
...
def test_diag_fee_decom(hi_l0_test_data_path):
    ...
    assert cdf_filepath.name == "imap_hi_l1a_45sensor-diagfee_20250208_v999.9999.cdf"
...
def test_app_nhk_decom(hi_l0_test_data_path):
    ...
    assert cem_raw_cdf_filepath.name == "imap_hi_l1a_90sensor-hk_20241105_v999.9999.cdf"
