...
EXTERNAL_TEST_DATA = [
    ...
    ("ultra_90_dps_exposure.csv", "ultra/data/l1/"),
    ("Ultra_90_DPS_efficiencies_all.csv", "ultra/data/l1/"),
    ("Ultra_efficiencies_45_combined_logistic_interpolation.csv", "ultra/data/l1/"),
    ("ultra_90_dps_gf.csv", "ultra/data/l1/"),
    ("ultra_90_dps_exposure.csv", "ultra/test_data/l1/"),
    ("Ultra_90_DPS_efficiencies_all.csv", "ultra/test_data/l1/"),
    ("ultra_90_dps_gf.csv", "ultra/test_data/l1/"),
