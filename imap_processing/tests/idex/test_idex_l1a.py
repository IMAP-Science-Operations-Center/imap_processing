...
def test_idex_cdf_file(decom_test_data_sci: xr.Dataset):
    ...
    assert file_name.name == "imap_idex_l1a_sci-10days_20231218_v999.9999.cdf"
...
def test_catlst_dataset(decom_test_data_catlst: list[xr.Dataset]):
    ...
    assert filename_l1a.name == "imap_idex_l1a_catlst-10days_20241206_v999.9999.cdf"

    filename_l1b = write_cdf(decom_test_data_catlst[1])
    assert filename_l1b.name == "imap_idex_l1b_catlst-10days_20241206_v999.9999.cdf"
...
def test_msg_dataset(decom_test_data_msg: xr.Dataset):
    ...
    assert filename_l1a.name == "imap_idex_l1a_msg-10days_20100101_v999.9999.cdf"
