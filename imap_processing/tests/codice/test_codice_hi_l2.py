...
def test_l2_hi_omni(mock_get_file_paths):
    sci_input = ScienceInput("imap_codice_l1b_hi-omni_20250814_v008.cdf")
    ...
    val_data = (
        ...
        / "imap_codice_l2_hi-omni_20250814_v008.cdf"
    )
...
def test_l2_hi_sectored(mock_get_file_paths):
    ...
    sci_input = ScienceInput("imap_codice_l1b_hi-sectored_20250814_v008.cdf")
    dependencies = ProcessingInputCollection(anc_input, sci_input)
    ...
    val_data = (
        imap_module_directory
        / "tests/codice/data/l2_validation"
        / "imap_codice_l2_hi-sectored_20250814_v008.cdf"
    )
