...
def test_l1b_lo_sw_species():
    ...
    cdf_file.rename("imap_codice_l1b_lo-sw-species_20250814_v999.cdf")
...
def test_l1b_lo_sw_angular():
    ...
    l1b_val_data = (
        ...
        / "data"
        / "l1b_validation"
        / "imap_codice_l1b_lo-sw-angular_20250814211100_v0.0.5.cdf"
    )
    l1b_val_data = load_cdf(l1b_val_data)
    processed_data = process_codice_l1b(processed_l1a_file)
    ...
    cdf_file.rename("imap_codice_l1b_lo-sw-angular_20250814_v999.cdf")
...
def test_l1b_lo_nsw_angular():
    ...
    cdf_file.rename("imap_codice_l1b_lo-nsw-angular_20250814_v999.cdf")
...
def test_l1b_hi_omni():
    ...
    cdf_file.rename("imap_codice_l1b_hi-omni_20250814_v999.cdf")
...
def test_l1b_hi_sectored():
    ...
    cdf_file.rename("imap_codice_l1b_hi-sectored_20250814_v999.cdf")
