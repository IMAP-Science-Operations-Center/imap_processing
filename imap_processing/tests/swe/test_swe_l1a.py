...
def test_cdf_creation():
    ...
    assert cem_raw_cdf_filepath.name == "imap_swe_l1a_sci_20240510_v999.9999.cdf"
...
def test_cdf_creation_hk():
    ...
    assert hk_cdf_filepath.name == "imap_swe_l1a_hk_20240510_v999.9999.cdf"
...
def test_cdf_creation_cem_raw():
    ...
    assert cem_raw_cdf_filepath.name == "imap_swe_l1a_cem-raw_20240510_v999.9999.cdf"
