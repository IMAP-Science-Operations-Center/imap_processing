        ...
        mag_data.append(
            {
                ...
                "mag_hk_status": {
                    "hk1v5_warn": int(status_data["hk1v5_warn"]),
                    "hk1v5_danger": int(status_data["hk1v5_danger"]),
                    "hk1v5c_warn": int(status_data["hk1v5c_warn"]),
                    "hk1v5c_danger": int(status_data["hk1v5c_danger"]),
                    "hk1v8_warn": int(status_data["hk1v8_warn"]),
                    "hk1v8_danger": int(status_data["hk1v8_danger"]),
                    "hk1v8c_warn": int(status_data["hk1v8c_warn"]),
                    "hk1v8c_danger": int(status_data["hk1v8c_danger"]),
                    "fob_saturated": int(status_data["fob_saturated"]),
                    "fib_saturated": int(status_data["fib_saturated"]),
                    "mode": int(status_data["mode"]),
                    "icu_temp": int(status_data["icu_temp"]),
                    "hk2v5_warn": int(status_data["hk2v5_warn"]),
                    "hk2v5_danger": int(status_data["hk2v5_danger"]),
                    "hk2v5c_warn": int(status_data["hk2v5c_warn"]),
                    "hk2v5c_danger": int(status_data["hk2v5c_danger"]),
                    "hk3v3": int(status_data["hk3v3"]),
                    "hk3v3_current": int(status_data["hk3v3_current"]),
                    "pri_isvalid": int(status_data["pri_isvalid"]),
                    "hkp8v5_warn": int(status_data["hkp8v5_warn"]),
                    "hkp8v5_danger": int(status_data["hkp8v5_danger"]),
                    "hkp8v5c_warn": int(status_data["hkp8v5c_warn"]),
                    "hkp8v5c_danger": int(status_data["hkp8v5c_danger"]),
                    ...
                    "multbit_errs": int(status_data["multbit_errs"]),
                    "sec_isvalid": int(status_data["sec_isvalid"]),
                },
            }
        )
