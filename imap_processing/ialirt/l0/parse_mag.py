        ...
        mag_data.append(
            {
                ...
                "ttj2000ns": int(met_to_ttj2000ns(met_all[i])),
                "instrument": "mag_hk",
                "mag_hk1v5_warn": bool(status_data["hk1v5_warn"]),
                "mag_hk1v5_danger": bool(status_data["hk1v5_danger"]),
                "mag_hk1v5c_warn": bool(status_data["hk1v5c_warn"]),
                "mag_hk1v5c_danger": bool(status_data["hk1v5c_danger"]),
                "mag_hk1v8_warn": bool(status_data["hk1v8_warn"]),
                "mag_hk1v8_danger": bool(status_data["hk1v8_danger"]),
                "mag_hk1v8c_warn": bool(status_data["hk1v8c_warn"]),
                "mag_hk1v8c_danger": bool(status_data["hk1v8c_danger"]),
                "mag_fob_saturated": bool(status_data["fob_saturated"]),
                "mag_fib_saturated": bool(status_data["fib_saturated"]),
                "mag_mode": int(status_data["mode"]),
                "mag_icu_temp": int(status_data["icu_temp"]),
                "mag_hk2v5_warn": bool(status_data["hk2v5_warn"]),
                "mag_hk2v5_danger": bool(status_data["hk2v5_danger"]),
                "mag_hk2v5c_warn": bool(status_data["hk2v5c_warn"]),
                "mag_hk2v5c_danger": bool(status_data["hk2v5c_danger"]),
                "mag_hk3v3": int(status_data["hk3v3"]),
                "mag_hk3v3_current": int(status_data["hk3v3_current"]),
                "mag_pri_isvalid": bool(status_data["pri_isvalid"]),
                "mag_hkp8v5_warn": bool(status_data["hkp8v5_warn"]),
                "mag_hkp8v5_danger": bool(status_data["hkp8v5_danger"]),
                "mag_hkp8v5c_warn": bool(status_data["hkp8v5c_warn"]),
                "mag_hkp8v5c_danger": bool(status_data["hkp8v5c_danger"]),
                "mag_hkn8v5": int(status_data["hkn8v5"]),
                "mag_hkn8v5_current": int(status_data["hkn8v5_current"]),
                "mag_fob_temp": int(status_data["fob_temp"]),
                "mag_fib_temp": int(status_data["fib_temp"]),
                "mag_fob_range": int(status_data["fob_range"]),
                "mag_fib_range": int(status_data["fib_range"]),
                "mag_multbit_errs": bool(status_data["multbit_errs"]),
                "mag_sec_isvalid": bool(status_data["sec_isvalid"]),
            }
        )
