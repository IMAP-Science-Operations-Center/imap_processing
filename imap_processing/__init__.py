...
try:
    from imap_processing._version import __version__ as __version__
    from imap_processing._version import __version_tuple__ as __version_tuple__
except ImportError:
    # _version.py is generated by poetry-dynamic-versioning at install time
    __version__ = "0.0.0"
