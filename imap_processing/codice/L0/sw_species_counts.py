"""This is the xtce generator for the P_COD_LO_SW_SPECIES_COUNTS packet."""
...
def main():
    packet_name = "P_COD_LO_SW_SPECIES_COUNTS"
    path_to_excel_file = (
    ...
    output_xml_path = "../../packet_definitions/codice/lo_sw_species_counts.xml"
