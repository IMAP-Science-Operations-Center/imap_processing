...
This module provides functionality to generate XTCE files for telemetry packets for swe.
...
def main():
    """Function can be used by swe to generate XTCE for a given number of packets. Change values where TODO is."""
